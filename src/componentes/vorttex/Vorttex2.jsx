import Vorttex from "./Vorttex"

const VorttexGamming = () => {
    return(
        <div className="group">
                        ...
                        <div className="mt-6">
                          ...
                          <div className="flex flex-wrap gap-2 mt-3">
                            ...
                            <span className="text-xs px-2 py-1 rounded-full bg-[#0f0f0f] text-[#64ffda] border border-[#64ffda]/20">Next.js</span>
                            ...
                            <span className="text-xs px-2 py-1 rounded-full bg-[#0f0f0f] text-[#64ffda] border border-[#64ffda]/20">Supabase</span>
                          </div>
                        </div>
                      </div>
    )
}
export default VorttexGamming