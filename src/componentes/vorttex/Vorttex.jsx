...
const Vorttex = () => {
  return (
    <>
      <div className="bg-transparent-bg px-6 mt-20  rounded-[5vh] h-[40%] w-[43vh] pb-4 mx-auto xl:ml-[5%] xl:w-[80vh] xl:h-[65vh] xl:mt-[20vh] border-zinc-950 border-2 2xl:h-[67vh] 2xl:w-[90vh]">
      ...
      <img
        src={vorttex00}
        className="mt-[5vh] w-[43vh] mx-auto xl:w-[50%] xl:mr-[2%] xl:-mt-[65vh] 2xl:-mt-[65vh] 2xl:w-[45%]"
      />
    </>
  );
};
