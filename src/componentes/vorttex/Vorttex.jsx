...
const Vorttex = () => {
  return (
    <>
      <div className="bg-transparent-bg px-6 mt-10  rounded-[5vh] h-[40%] w-[43vh] pb-4 mx-auto md:ml-[5%] md:w-[80vh] md:h-[65vh] md:mt-[15vh] border-zinc-950 border-2">
      ...
      <div className="px-6 mt-[1vh] md:ml-[5%]">
        <Button
          ...
          variant="faded"
        >
          <a href="https://pf-final-damian-projects.vercel.app/">Ir al sitio</a>
        </Button>
      </div>
      <img
        src={vorttex00}
