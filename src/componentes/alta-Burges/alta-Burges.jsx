...
const AltaBurgers = () => {
  return (
    <>
      <div className="bg-transparent-bg px-6 mt-10   rounded-[5vh] h-[40%] pb-4 w-[43vh] mx-auto xl:mt-[15vh]  xl:w-[80vh] xl:h-[70vh] xl:mr-[2%] border-zinc-950 border-2 2xl:h-[43vh] 2xl:w-[90vh]">
      ...
      <img
        src={burge}
        className="mt-[5vh] w-[43vh] mx-auto xl:w-[40%] xl:ml-[5%] xl:-mt-[70vh] 2xl:-mt-[43vh] 2xl:rounded-xl"
      />
    </>
  );
};
